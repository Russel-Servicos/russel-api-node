...
async function sendOrderEmail(
    ...
    const mailGroup = `${order.user.email}, ${env.emailsImplantacao}`;
...
function registerEmailHelpers(mailer: Mailer) {
    mailer.registerHelper("itemTotal", function (this: { qtd: number; price: number }) {
    ...
    mailer.registerHelper("itemDescription", function (this: { description: string }) {
